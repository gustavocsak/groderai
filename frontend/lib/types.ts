  ...
  students: [
    {
      ...
      summary: [
        "Use Javadoc comment style and comment your classUse Javadoc comment style and comment your classUse Javadoc comment style and comment your classUse Javadoc comment style and comment your classUse Javadoc comment style and comment your classUse Javadoc comment style and comment your class",
        "describe the parameter(s) required for each method",
        "describe the return value (or output) for each method",
        "describe the purpose of the program",
        "Comment should be placed on the top of the method",
